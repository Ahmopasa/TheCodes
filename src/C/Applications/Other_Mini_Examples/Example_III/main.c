...
void ShufflePlayer(struct myCasino myPoker[turn][user][2]);
void ShuffleBoard(struct myCasino onBoard[turn][5]);

int main() {


	my_random();
	struct myCasino player[turn][user][2] = { 0 };
	struct myCasino board[turn][5] = {0};
